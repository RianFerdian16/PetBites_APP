          ...
          <section className="admin-editor-panel">
            ...
            <form onSubmit={save} className="admin-form">
              ...
              <AiAssistant
                ...
                onAsk={() => void askAi()}
                canApply={
                  canEdit && !operationBusy && (aiAction === "draft" || aiAction === "improve")
                }
                canCopy={!operationBusy && aiAction === "translate" && Boolean(aiText.trim())}
...
function prepareRecord(entity: AdminEntity, draft: AdminRecord, requireId = true): AdminRecord {
  ...
  if (requireId) validateRequiredFields(entity, record);
  return record;
}
