...
export function HomePage({
  ...
  const filteredBirds = useMemo(() => {
    ...
    return birds.filter((bird) => {
      const localizedName = birdName(bird.name, bird.nameEn);
      const localizedDescription = birdDescription(bird.description, bird.descriptionEn);
      return normalize(
    ...
    >
      ...
      >
        ...
        <div className="bird-card__body">
          ...
          <p className="bird-card__description">
